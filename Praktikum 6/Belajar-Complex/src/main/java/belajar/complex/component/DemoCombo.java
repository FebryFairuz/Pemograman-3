...
public class DemoCombo {
    private static JComboBox cmbMhs = new JComboBox();
    private static final List<String> dfrMhs = new ArrayList<String>();

    public static void isiCombo(){
        // data dimasukkan ke dalam class model
        DefaultComboBoxModel model 
            = new DefaultComboBoxModel(dfrMhs.toArray());
        
        // pasang model di combo
        cmbMhs.setModel(model);
    }
    ...
    public static void main(String[] xx){
        ...
        cmbMhs.addActionListener(new PilihanComboListener());
    }
}
