...
public class tugas{
	private static JComboBox cmbHobi = new JComboBox();
	private static JList listData = new JList();
	private static List<String> dftrHobi = new ArrayList<String>();
	private static final List<Record> dftrHasil = new ArrayList<Record>();
	
	public static void isiData(){
		DefaultComboBoxModel model = new DefaultComboBoxModel(dftrHasil.toArray());
		listData.setModel(model);
	}
	public static void tambahListData(Record re){
		dftrHasil.add(re);
		isiData();
	}
	...
	public static void main (String[] xx){
		...
		reset bnReset = new reset();
		btnReset.addActionListener(bnReset);
